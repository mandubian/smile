 ...
 * @author Haifeng Li
 */
public class QuantileRandomForest implements Regression<double[]>, Serializable {
    private static final long serialVersionUID = 1L;

    /**
     * Forest of regression trees.
     */
    private List<QuantileRegressionTree> trees;
    /**
    ...
    public static class Trainer extends RegressionTrainer<double[]> {
        ...
        @Override
        public QuantileRandomForest train(double[][] x, double[] y) {
            return new QuantileRandomForest(attributes, x, y, ntrees, maxNodes, nodeSize, mtry, subsample);
        }
    }
     ...
     */
    static class TrainingTask implements Callable<QuantileRegressionTree> {
        /**
        ...
        @Override
        public QuantileRegressionTree call() {
            int n = x.length;
            ...
            QuantileRegressionTree tree = new QuantileRegressionTree(attributes, x, y, maxNodes, nodeSize, mtry, order, samples, null);
     ...
     * @param ntrees the number of trees.
     */
    public QuantileRandomForest(double[][] x, double[] y, int ntrees) {
     ...
     */
    public QuantileRandomForest(double[][] x, double[] y, int ntrees, int maxNodes, int nodeSize, int mtry) {
     ...
     * @param ntrees the number of trees.
     */
    public QuantileRandomForest(Attribute[] attributes, double[][] x, double[] y, int ntrees) {
     ...
     * @param maxNodes the maximum number of leaf nodes in the tree.
     */
    public QuantileRandomForest(Attribute[] attributes, double[][] x, double[] y, int ntrees, int maxNodes) {
     ...
     * @param maxNodes the maximum number of leaf nodes in the tree.
     */
    public QuantileRandomForest(Attribute[] attributes, double[][] x, double[] y, int ntrees, int maxNodes, int nodeSize) {
     ...
     * @param maxNodes the maximum number of leaf nodes in the tree.
     */
    public QuantileRandomForest(Attribute[] attributes, double[][] x, double[] y, int ntrees, int maxNodes, int nodeSize, int mtry) {
     ...
     */
    public QuantileRandomForest(Attribute[] attributes, double[][] x, double[] y, int ntrees, int maxNodes, int nodeSize, int mtry, double subsample) {
        ...
        for (QuantileRegressionTree tree : trees) {
    ...
    public void trim(int ntrees) {
        ...
        List<QuantileRegressionTree> model = new ArrayList<>(ntrees);
        for (int i = 0; i < ntrees; i++) {
     ...
     */
    public QuantileRegressionTree[] getTrees() {
        return trees.toArray(new QuantileRegressionTree[trees.size()]);
    }
}
